            ...
            <div class="row d-md-flex no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
                ...
                <div class="one-forth d-flex js-fullheight align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                    <div class="text mt-md-5">
                        <h1 class="mb-4">Ushqehu Shendetshem <br> me Dieta vetem per ty</h1>
                        <p>Me ne ne krah ju do te jeni ne gjendje te gjeni dieten tuaj te personalizuar per te arritur rezultate maksimale</p>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" placeholder="Vendosni emrin tuaj">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="select-wrap one-third">
                                    ...
                                    <select name="duration" class="form-control">
                                        <option value="">Sa do te jete kohezgjatja</option>
                                        <option value="7">1 jave</option>
                                        <option value="21">3 jave</option>
                                        <option value="30">1 muaj</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="select-wrap one-third">
                                    ...
                                    <select name="category" id="" class="form-control">
                                        <option value="">Pjese e ciles kategori jeni</option>
                                        <option value="isVegan">Vegan</option>
                                        <option value="isDiaryFree">Vegjetarjan</option>
                                        <option value="isGlutenFree">Nuk perdorni sheqernat</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 mt-3">
                            <div class="form-group">
                                <button type="button" class="search-btn btn btn-primary py-3 px-5">Kerko Dieten</button>
                            </div>
                        </div>
                    </div>
                </form>
